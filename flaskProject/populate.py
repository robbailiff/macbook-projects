...
# Lets import our Book and Base classes from our database_setup.py file
...
# and represents a "staging zone" for all the objects load into the database session object
session = DBSession()
